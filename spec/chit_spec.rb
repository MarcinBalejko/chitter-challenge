...
describe Chit do
  ...
  let(:chit_1) { Chit.create(text: 'Test Chit 1', author_id: user.id, author_email: 'user@gmail.com') }
  let(:chit_2) { Chit.create(text: 'Test Chit 2', author_id: user.id, author_email: 'user@gmail.com') }
  let(:chit_3) { Chit.create(text: 'Test Chit 3', author_id: user.id, author_email: 'user@gmail.com') }
  describe '.all' do
  ...
  describe '.update' do
    it 'updates the chit with the given data' do
      chit_1
      updated_chit = Chit.update(id: chit_1.id, text: 'Test Chit 2', author_id: user.id, author_email: user.email)
